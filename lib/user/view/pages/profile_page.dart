...
import 'package:shubhyatri/user/view/pages/service_page.dart';
import 'package:shubhyatri/user/view/pages/travel_history.dart';
          ...
          child: ListView(
            ...
            children: [
              ...
              _widgetCard('History', 'Travel history',
                ...
                NavigatorPage.to(context, const TravelHistory());
              }),
              _widgetCard('Review', 'Your feedback',
                  CupertinoIcons.staroflife_fill, () {}),
              _widgetCard('Services', 'Our services',
                  CupertinoIcons.rectangle_arrow_up_right_arrow_down_left, () {
                NavigatorPage.to(context, const ServicePage());
              }),
